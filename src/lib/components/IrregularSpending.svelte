<script lang="ts">
	...
	const CATEGORY_LABELS: Record<string, string> = {
		transport: 'Transport', shopping: 'Shopping', mat: 'Mat ute',
		helse: 'Helse', underholdning: 'Underholdning', barn: 'Barn',
		bolig: 'Bolig', forsikring: 'Forsikring', abonnement: 'Abonnement',
		overføring: 'Overføring', annet: 'Annet',
	};
