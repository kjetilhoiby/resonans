<script lang="ts">
	...
	let { book, themeId, onRefresh }: Props = $props();
...
<style>
	...
	.bk-ctx-empty { color: #888; padding: 2rem 0; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 0.85rem; }
