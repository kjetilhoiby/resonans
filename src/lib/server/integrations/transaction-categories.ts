...
export type { CategoryId, Category } from '$lib/integrations/transaction-categories-client';
export { CATEGORIES } from '$lib/integrations/transaction-categories-client';
