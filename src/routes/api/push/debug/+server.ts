...
import { checkVapidKeyPairMatch } from '$lib/server/web-push';
...
export const GET: RequestHandler = async ({ locals }) => {
	...
	const keyPairCheck = checkVapidKeyPairMatch();
	...
	return json({
		vapid: {
			...
			keyPairMatch: keyPairCheck.match,
			keyPairError: keyPairCheck.error
		},
